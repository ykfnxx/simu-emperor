...
class TestTapeWriter:
    ...
    async def test_write_event_creates_file(self, tmp_path):
        ...
        event = Event(
            ...
            payload={"query": "我之前给直隶拨过款吗？", "event_type": EventType.USER_QUERY},
    ...
    async def test_write_event_format(self, tmp_path):
        ...
        event = Event(
            ...
            dst=["player"],
            type=EventType.USER_QUERY,
            payload={"query": "拨款给直隶", "event_type": EventType.USER_QUERY},
            session_id="session:cli:default",
        )
    ...
    async def test_event_id_uniqueness(self, tmp_path):
        ...
        event1 = Event(
            ...
            dst=["player"],
            type=EventType.USER_QUERY,
            payload={"query": "test1", "event_type": EventType.USER_QUERY},
            session_id="session:cli:default",
        )
        ...
        event2 = Event(
            ...
            dst=["player"],
            type=EventType.USER_QUERY,
            payload={"query": "test2", "event_type": EventType.USER_QUERY},
            session_id="session:cli:default",
        )
